...
use App\Models\YayasanDocument as ModelsYayasanDocument;
use Livewire\WithPagination;

class YayasanDocument extends Component
{
    ...
    public function render()
    {
        ...
        $documents = ModelsYayasanDocument::when(!empty($this->search), function ($query) use ($search) {
        ...
        return view('livewire.yayasan-document', $data);
    }
    ...
    public function store()
    {
        ...
        $file = $this->file->store('berkas/yayasan', 'public');

        ModelsYayasanDocument::create([
            'name' => $this->name,
            'file' => $file,
        ]);
    ...
    public function destroy()
    {
        ...
        ModelsYayasanDocument::destroy($this->idBerkas);
