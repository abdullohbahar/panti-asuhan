<div>
    <!-- Modal -->
    <div wire:ignore.self class="modal fade" id="modal-export-pdf" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Export Donasi PDF</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form wire:submit.prevent="exportValidation">
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <button class="btn btn-danger btn-block">Export PDF</button>
                                </div>
                            </div>
                        </div>
                    </form>
    ...
    <div wire:ignore.self class="modal fade" id="modal-export-pdf" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('export.donasi.pdf') }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-sm-12 col-md-6 col-lg-6">
                                <div class="form-group">
                                    <label>Mulai Tanggal</label>
                                    <input type="date" name="date1" class="form-control @error('date1') is-invalid @enderror" id="">
                                    @error('date1')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="col-sm-12 col-md-6 col-lg-6">
                                <div class="form-group">
                                    <label for="">Sampai Tanggal</label>
                                    <input type="date" name="date2" class="form-control @error('date2') is-invalid @enderror" id="">
                                    @error('date2')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
