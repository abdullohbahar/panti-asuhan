                                ...
                                @foreach ($donations as $index => $donation)
                                    <tr>
                                        ...
                                        <td data-label="Aksi">
                                            ...
                                            <a href="{{ route('print.invoice.donation',$donation->id) }}" class="btn btn-primary btn-sm" data-toggle="tooltip" data-placement="top" title="download bukti"><i class="fas fa-print"></i></a>
