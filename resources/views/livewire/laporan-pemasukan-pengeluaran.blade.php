            ...
            <div class="card">
                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-2 col-xl-2">
                            <div class="form-group">
                                <a href="{{ route('laporan.pemasukan.pengeluaran') }}"
                                    class="btn btn-warning btn-block">Reset Filter</a>
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-12 col-lg-2 col-xl-2">
                            <div class="form-group">
                                @if ($date1)
                                    <a href="{{ url('cetak-laporan-pemasukan-pengeluaran-donasi-excel/' . $date1 . '/' . $date2) }}"
                                        class="btn btn-success btn-block"><i class="fas fa-file-excel"></i> Export
                                        Excel</a>
                                @else
                                    <a href="{{ url('cetak-laporan-pemasukan-pengeluaran-donasi-excel/0/0') }}"
                                        class="btn btn-success btn-block"><i class="fas fa-file-excel"></i> Export
                                        Excel</a>
                                @endif
                            </div>
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-2 col-xl-2">
                            <div class="form-group">
                                @if ($date1)
                                    <a href="{{ url('cetak-laporan-pemasukan-pengeluaran-donasi/' . $date1 . '/' . $date2) }}"
                                        class="btn btn-danger btn-block"><i class="fas fa-file-pdf"></i> Export PDF</a>
                                @else
                                    <a href="{{ url('cetak-laporan-pemasukan-pengeluaran-donasi/0/0') }}"
                                        class="btn btn-danger btn-block"><i class="fas fa-file-pdf"></i> Export PDF</a>
                                @endif
                            </div>
                        </div>
                                        ...
                                        @foreach ($donations as $index => $donation)
                                            ...
                                            <tr>
                                                ...
                                                <td data-label="Donatur">
                                                    {{ $donation->donaturName != null ? $donation->donaturName->nama : '' }}
                                                </td>
