<div>
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Data Warga Jompo</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
            <li class="breadcrumb-item active">Data Warga Jompo</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-3 col-xl-3 text-right">
                        <div class="row">
                            ...
                            <div class="col-ms-12 col-md-6">
                                <a href="{{ route('export.warga','Jompo') }}" class="btn btn-danger btn-sm btn-block mt-2"><b><i class="fas fa-file-pdf"></i> Export PDF</b></a>
                            </div>
                        </div>
                    </div>
                </div>
