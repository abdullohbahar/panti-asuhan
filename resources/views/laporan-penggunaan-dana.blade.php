...
@section('content')
<div>
  <livewire:laporan-penggunaan-dana>
</div>
@endsection
...
<script>
  ...
  $("#btnAddReport").on("click", () => {
    $("#modal-add-report-fund").modal("show")
  })
  ...
  window.addEventListener('close-modal', event => {
    // close modal
    $('#modal-add-report-fund').modal('hide')
    $('#modal-edit-report-fund').modal('hide')
