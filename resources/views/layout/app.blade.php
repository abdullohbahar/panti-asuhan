...
<body class="hold-transition sidebar-mini">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="{{ route('dashboard') }}" class="brand-link text-center">
                @php
                    ...
                    } elseif (strpos(auth()->user()->role, 'lksa')) {
                        $logo = '/logo-lksa.jpg';
                    } else {
                        $logo = '/logo-yayasan.png';
                    }
                @endphp
                <img src="{{ asset('./logo' . $logo) }}" class="img-circle elevation-3"
                    style="opacity: .8; width: 60%; margin-top: -10px; margin-bottom: -10px;">
    ...
    <script>
        function openWindowPopup(url, lebar, tinggi) {
            ...
            window.open(url, '', 'toolbar=0,location=0,directories=0,status=0,menubar=0,scrollbars=1,resizable=1,width=' +
                lebar + ',height=' + tinggi + ',top=' + top + ',left=' + left);
        }
